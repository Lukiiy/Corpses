...
A **PaperMC** plugin adds corpses to the game, for those who have died. It uses the _Mannequin_ entity to display a body, and it works very well! Those will persist between server restarts or world changes.  
